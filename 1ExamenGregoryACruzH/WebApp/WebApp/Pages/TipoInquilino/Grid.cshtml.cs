...
namespace WebApp.Pages.TipoInquilino
{
    public class GridModel : PageModel
    {
        ...
        public GridModel(ITipoInquilinoService empleadoService)
        {
            this.tipoInquilinoService = empleadoService;
        }
        ...
        public async Task<IActionResult> OnGetEliminar(int id)
        {
            ...
            try
            {
                var result = await tipoInquilinoService.Delete( new() { IdTipoInquilino = id});
