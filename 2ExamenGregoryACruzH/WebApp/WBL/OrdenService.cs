...
namespace WBL
{
    ...
    public class OrdenService : IOrdenService
    {
        ...
        public async Task<IEnumerable<OrdenEntity>> Get()
        {
            try
            {
                var result = sql.QueryAsync<OrdenEntity, ProductoEntity>("exp.OrdenObtener", "IdOrden,IdProducto");
        ...
        public async Task<OrdenEntity> GetById(OrdenEntity entity)
        {
            try
            {
                var result = sql.QueryFirstAsync<OrdenEntity>("exp.OrdenObtener", new
                { entity.IdOrden });
        ...
        public async Task<DBEntity> Create(OrdenEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("exp.OrdenInsertar", new
                {
                    entity.IdProducto,
        ...
        public async Task<DBEntity> Update(OrdenEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("exp.OrdenActualizar", new
                {
                    entity.IdOrden,
                    entity.IdProducto,
                    entity.CantidadProducto,
        ...
        public async Task<DBEntity> Delete(OrdenEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("exp.OrdenEliminar", new
                {
                    entity.IdOrden,
